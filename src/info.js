import couscousImg from './images/couscous.jpg';
import zvitiImg from './images/zviti2.jpeg';
import chakhchokhaImg from './images/chakhchoka.jpeg';
import teaImg from './images/sahara-tea.jpg';
import baklavaImg from './images/baklava.jpg';
import mamaImg from './images/mama-camel.jpg';
import papaImg from './images/papa-camel.jpg';
import babyImg from './images/baby-camel.jpg';
...
const mainDishes = {
  ...
  couscous: {
    ...
    price: '3$',
    imgSrc: couscousImg, // Image by chefmouhcine on pixabay, https://pixabay.com/photos/couscous-vegetable-meat-recipe-3440042/
  },
  zviti: {
    name: 'Zviti',
    ...
    price: '4$',
    imgSrc: zvitiImg, // Image by Djazair Cooking on tweeter post, https://twitter.com/DjazairCooking/status/1519767427684438017/photo/1
  },
  chakhchokha: {
    name: 'Chakhchokha',
    ...
    price: '3$',
    imgSrc: chakhchokhaImg, // Image from https://www.myexcellentdegustations.com/algerian-thin-flatbread-with-meat-sauce-chakhchoukha/
  },
};
...
const entrees = {
  ...
  tea: {
    ...
    price: '0.5$',
    imgSrc: teaImg, // Image by pirkerchri on pixabay, https://pixabay.com/images/id-2431459/
  },
  baklava: {
    name: 'Baklava',
    ...
    price: '2$',
    imgSrc: baklavaImg, // Image by fabrikasimf on Freepik, https://www.freepik.com/author/fabrikasimf
  },
};
